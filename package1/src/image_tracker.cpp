...
class Controller {
	...
	void imageCallback(const sensor_msgs::ImageConstPtr& msg){ //change of the Scope to controller class
	...
	waitKey(1);
        ...
        {
	    //change of the Scope to controller class
	    ...
	    ROS_INFO("%d %d",msg->Smax,msg->Smin);
	    ROS_INFO("%d %d",msg->Vmax,msg->Vmin);
